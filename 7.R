...
start_time <- '2018-09-30+00:00:00'
end_time <-
  '2018-10-01+00:00:00'  ####format(Sys.time(), format = '%Y-%m-%d+%H:%M:%S')  #######
loop_time <- NA
start_num <- 0
length <- 5000
draw <- '1'
...
handle <-
  getCurlHandle(
    httpheader = list(
      ...
      Cookie = 'JSESSIONID=79538355773713500F3C3EC03D7FBA5B; theme=theme_base; userName=%E6%9D%8E%E9%95%BF%E5%85%B4; token=8617ea3a5690ba4c00fd318fe4c0d964; userId=s00580; userType=CBUSER',
