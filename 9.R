...
handle <-
  getCurlHandle(
    httpheader = list(
      ...
      Cookie = 'JSESSIONID=85183F15160DBDA55759D45C8FDFD579; theme=theme_base; userName=%E6%9D%8E%E9%95%BF%E5%85%B4; token=98c3cc5b50c9f0359ce566792e22baf2; userId=s00580; userType=CBUSER',
